...
> 历史审计：本文记录 2026-07-18 当时的状态。后续 `5b208f4` 已完成本地文件工作流，`647135f` 已完成 Android 兼容矩阵；0.1.0 的最终范围与结果以根目录 `README.md` 和 `docs/releases/0.1.0.md` 为准。远程服务器功能在 0.1.0 隐藏并延后。
