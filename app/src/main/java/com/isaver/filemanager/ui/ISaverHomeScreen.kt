...
import com.isaver.filemanager.ui.files.FilesBottomBar
...
import com.isaver.filemanager.ui.recent.RecentScreen
import com.isaver.filemanager.ui.recent.RecentUiItem
import com.isaver.filemanager.ui.recent.RecentUiState
import com.isaver.filemanager.ui.archive.ArchiveScreen
import com.isaver.filemanager.ui.archive.ArchiveUiState
...
import com.isaver.filemanager.ui.virtualviews.VirtualViewUiState
import com.isaver.filemanager.ui.virtualviews.VirtualReferencePickerDialog
...
import com.isaver.filemanager.ui.dualpane.DualPaneScreen
import com.isaver.filemanager.ui.dualpane.DualPaneState
...
fun ISaverHomeScreen(
    ...
    onBrowserBack: () -> Unit,
    onNavigateBrowserPath: (RootPath) -> Unit = {},
    ...
    onArchiveBack: () -> Unit = {},
    onEnterArchiveDirectory: (com.isaver.filemanager.archive.ArchiveNode) -> Unit = {},
    ...
    Column(modifier.fillMaxSize().background(ISaverBackground)) {
        when (homeState.destination) {
            ...
            is HomeDestination.Browser -> if (
                ...
                onNavigateToPath = onNavigateBrowserPath,
                showPath = true,
                ...
                onOpenHex = if (saveMode) null else onOpenHex,
                onCompareSelection = if (saveMode) null else onCompareSelection,
