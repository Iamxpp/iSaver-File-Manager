...
import com.isaver.filemanager.fileops.BatchRenameItem
import com.isaver.filemanager.fileops.BatchRenamePlan
import com.isaver.filemanager.fileops.BatchRenameRule
import com.isaver.filemanager.tasks.OperationRecoveryPolicy
                ...
                onPreviewBatchRename = { rule ->
                    ...
                    currentState = currentState.copy(
                        batchRenamePlan = BatchRenamePlan(
                            listOf(
                                BatchRenameItem(first, com.isaver.filemanager.domain.EntryName.parse("new-a.txt").getOrThrow()),
                                BatchRenameItem(second, com.isaver.filemanager.domain.EntryName.parse("new-b.txt").getOrThrow()),
                            ),
                        ),
                    )
                },
